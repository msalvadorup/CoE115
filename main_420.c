...
#define KP_R1 PORTAbits.RA0
#define KP_R2 PORTAbits.RA1
#define KP_R3 PORTAbits.RA2
#define KP_R4 PORTAbits.RA3
        ...
        while(mode == 1) {
            if(keyPressed) {
                if((key == 11) && (cursor!=0)) {
                    ...
                    cursor++;
                } else if(((key!=12) || (key!=11)) && ((cursor!=2) || (cursor!=5) || (cursor!=8) || (cursor!=11))) {
                    print(int_to_string(key));
                } else if((cursor==16) && (key==12)) {
                    mode=2;/*
